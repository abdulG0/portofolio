const translations: Record<string, any> = {
  ...
  ar: {
    ...
    skills: { categories: [ { name: "الهندسة البرمجية", skills: ["Next.js", "TypeScript", "React", "Node.js", "تصميم قواعد البيانات", "تطوير واجهات برمجية"] }, { name: "الذكاء الاصطناعي", skills: ["الذكاء الاصطناعي والتعلم الآلي", "الذكاء الاصطناعي المحادثي", "أتمتة سير العمل", "نماذج اللغات الكبيرة"] }, { name: "تكامل الأنظمة", skills: ["إنترنت الأشياء", "تكامل الأجهزة والبرمجيات", "الشبكات", "أنظمة الدفع"] }, { name: "السحابة و DevOps", skills: ["نشر السحابة", "Docker", "CI/CD", "الأمان"] }, { name: "الأعمال والاستشارات", skills: ["الاستراتيجية الرقمية", "أتمتة العمليات", "تقييم التكنولوجيا", "إدارة المشاريع"] } ] },
